  ...
  const handleStatusChange = async (id, newStatus) => {
    try {
      ...
      if (res.ok) {
        ...
        fetchAllInquiries(); // Refresh list
      } else {
        const data = await res.json();
              ...
              <div key={inq._id} className="p-4 hover:bg-gray-50">
                <div className="grid grid-cols-12 items-center gap-4">
                  ...
                  <div className="col-span-3">
                    ...
                    <p className="text-sm text-gray-600">{inq.userId?.email || "N/A"}</p>
                    {inq.userId?.mobile && (
                      ...
                      {inq.products.slice(0, 2).map((prod, idx) => (
                        <div key={idx} className="flex items-center">
                          ...
                          <span className="ml-2 text-sm">
                            {prod.productId?.productName || "Unnamed Product"} (x{prod.quantity})
                          </span>
                        </div>
                      ))}
                      ...
                      <div>
                        ...
                        <div className="space-y-3">
                          {inq.products.map((prod, idx) => {
                            ...
                            return (
                              <div key={idx} className="flex items-start border border-gray-200 rounded p-3">
                                <img
                                ...
                                <div className="ml-3 flex-grow">
                                  ...
                                  <p className="text-sm">
                                    Quantity: <span className="font-medium">{prod.quantity}</span>
                                  </p>
                                </div>
                              </div>
                            );
